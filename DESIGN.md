...
| `.bridge-panel` / `.target-card` | Developer-facing native spike surface using the same glass shell and compact readable target rows | Status data must be scannable; do not turn diagnostics into decorative cards |
